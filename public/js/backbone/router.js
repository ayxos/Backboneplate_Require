define(function(require) {
  ...
  , PeopleCollection = require('js/backbone/entities/peopleCollection')
  , PeopleView = require('js/backbone/views/PeopleView')
  , PeopleListView = require('js/backbone/views/peopleListView')
  , HomeView = require('js/backbone/views/homeView');
